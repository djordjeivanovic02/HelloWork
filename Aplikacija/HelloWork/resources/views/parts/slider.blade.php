...
<div class="w-100">
    <div class="sliders_control">
        <input id="fromSlider" name="minPrice" type="range" value="0" min="0" max="100" />
        <input id="toSlider" name="maxPrice" type="range" value="100" min="0" max="100" />
    </div>
    <div class="form_control w-100">
        <div class="form_control_container w-100 d-flex justify-content-center">
            ...
            <div class="price-preview">
                <p class="m-0">€<span id="fromPrice">0</span> €<span id="toPrice">100000</span></p>
            </div>
        </div>
    </div>
