<div class="application-container w-100 p-4">
    <p class="application-name m-0"><a href="">PHP Web Developer</a></p>
    <div class="row-images w-100 my-2 mb-3">
        <div>
            <a href="" class="my-1 application-category">Microsoft</a>
    ...
    <div>
        ...
        <div class="cancel-application w-100 d-flex align-items-center justify-content-between">
            <p class="m-0">Postavljeno pre: <span>2 dana</span></p>
            <button>Otkaži Apliciranje</button>
        </div>
    </div>
</div>