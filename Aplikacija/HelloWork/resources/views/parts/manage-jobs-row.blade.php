<tr id="row_ad_{{ $id }}">
            ...
            <div class="row-images w-100">
                <div>
                    <div>
                        ...
                        <p class="row-info m-0 d-inline-block">{{ $city }}</p>
                    </div>
                    <div>
                        <svg class="d-inline-block" width="18" height="19" viewBox="0 0 13 15" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <p class="row-info m-0 d-inline-block">
                            @if ($workTime == 1)
                                Puno radno vreme
                            @else
                                Nepuno radno vreme
    ...
    <td class="status-column">
        @if ($status == null)
            <p class="ad-state pending m-0">Čeka na proveru</p>
        @endif
        @if ($status == 1)
            <p class="ad-state active m-0">Aktivan</p>
        @endif
    </td>
    <td>
        <div class="d-inline-block">
            <div class="action-btns look-btn d-flex justify-content-center align-items-center"
                onclick="showDialog('quick_preview_{{ $id }}')">
        ...
        <div class="d-inline-block">
            <div class="action-btns delete-btn d-flex justify-content-center align-items-center"
                onclick="showDialog('delete_ad_{{ $id }}')">
...
@component('dialogs.notification', [
    ...
    'message' => 'Da li ste sigurni da želite da obrišete oglas ' . $title . '?',
    'close' => true,
    'actions' => [
        [
            'url' => "deleteJob($id)",
...
@component('dialogs.quick-preview', [
    'id' => $id,
    'title' => $title,
