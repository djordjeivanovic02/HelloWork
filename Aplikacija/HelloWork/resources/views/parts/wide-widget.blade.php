<div class="long-container d-flex flex-column">
    <div class="prvi-red d-flex justify-content-between align-items-start">
        ...
        <div @if ($active)
            class="save-it-div active d-flex justify-content-center align-items-center"
            @else
            class="save-it-div d-flex justify-content-center align-items-center"
            @endif 
            onclick="saveJob(1, this)"
            >
