                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                ...
                                                                <strong>Potvrda email adrese</strong>
                                                            </h1>
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-size: 18px; line-height: 32.4px; font-family: Lato, sans-serif;"><strong><span
                                                                                style="line-height: 32.4px; font-size: 18px;">Poštovani
                                                                                korisniče,
                                                                            </span></strong></span></p>
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        ...
                                                                        Upravo je kreiran nalog na platformi Hello<span
                                                                            style="color: #613FE5">Work</span> sa ovom
                                                                        email adresom. Ukoliko ste to bili Vi, molimo
                                                                        vas da verifikujete svoju email adresu kako
                                                                        biste mogli da koristite usluge platforme. U
                                                                        suprotnom možete zanemariti ovaj email.
                                                                    </span></p>
                                                                <p style="font-size: 14px; line-height: 180%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-size: 16px; line-height: 28.8px; font-family: Lato, sans-serif;"><strong><span
                                                                                ...
                                                                                Verifikujte email adresu samo u sledećim
                                                                                slučajevima:</span></strong></span></p>
                                                                <ul style="list-style-type: square;">
                                                                    <li style="font-size: 14px; line-height: 25.2px;">
                                                                        <span
                                                                            style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"><strong>Vi
                                                                                ste se savesno registrovali na platformu
                                                                                Hello<span
                                                                                    style="color: #613FE5">Work</span>
                                                                            </strong></span>
                                                                    </li>
                                                                    <li style="font-size: 14px; line-height: 25.2px;">
                                                                        <span
                                                                            style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"><strong>
                                                                                Ne nameravate ništa nezakonito u vezi sa
                                                                                platformom</strong></span>
                                                                    </li>
                                                                    <li style="font-size: 14px; line-height: 25.2px;">
                                                                        <span
                                                                            style="font-family: Lato, sans-serif; font-size: 16px; line-height: 28.8px;"><strong>
                                                                                Nećete drugima davati pristup vašim
                                                                                podacima</strong></span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                ...
                                                                <a href="{{ route('verify-email', ['id' => $user->id]) }}"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:20px 70px;line-height:120%;"><strong><span
                                                                                style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 16.8px;">V
                                                                                E R I F I K U J&nbsp; &nbsp;S A D
                                                                                A</span></strong></span>
                                                                </a>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        ...
                                                                        Garantujemo vam da vaši podaci neće biti
                                                                        zloupotrebljeni, i korišćeni u druge svrhe osim
                                                                        za lagodno korišćenje naše platforme.
                                                                    </span></p>
                                                                <p style="font-size: 14px; line-height: 170%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">
                                                                        Ukoliko imate nekih pitanja ili problema, možete
                                                                        nam se obratiti na email adresi:
                                                                        <b>timauroraa@gmail.com</b>.
                                                                    </span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 170%;">&nbsp;
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-family: Lato, sans-serif; font-size: 16px; line-height: 27.2px;">S
                                                                        poštovanjem,</span></p>
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-family: Lato, sans-serif; font-size: 14px; line-height: 23.8px;"><strong><span
                                                                                style="font-size: 16px; line-height: 27.2px;">Aurora
                                                                                Tim</span></strong></span></p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size" <p
                                                                style="font-size: 14px; line-height: 210%;"><span
                                                                    style="font-family: Lato, sans-serif; font-size: 14px; line-height: 29.4px;">
                                                                    <p style="color: white; text-align-center">© 2024
                                                                        HelloWork.
                                                                        Napravljeno od
                                                                        strane <span style="color: #613FE5">Aurora
                                                                            Team</span>. Sva prava
                                                                        zadržana. </p>
                                                                </span></p>
                                                            </div>
