                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        ...
                                                                        Upravo ste zahtevali resetovanje lozinke na
                                                                        platformi Hello<span
                                                                            style="color: #613FE5">Work</span> sa ovom
                                                                        email adresom. Ukoliko to niste bili Vi, molimo
                                                                        vas da zanemarite ovaj mail.
                                                                    </span>
                                                                </p>
                                                            </div>
                                                                ...
                                                                <a href="{{ route('reset-password', ['id' => $user->id]) }}"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:20px 70px;line-height:120%;"><strong><span
                                                                                style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 16.8px;">P
                                                                                R O M E N I&nbsp; &nbsp;L O Z I N K U
                                                                            </span>
                                                                        </strong></span>
                                                                </a>
